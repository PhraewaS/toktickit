...
| UI-06g | regression | AC-05/15 | authenticated Lab 3 client does not render or call the Development Requester selector | `client/tests/lab-03/NoDevelopmentRequesterSelector.test.tsx` | Planned |
...
| STYLE-01 | UI style | AC-14 | Zen Green tokens, badges, focus and read-only styling | `client/tests/lab-03/ZenGreenStyle.test.tsx` | Planned |
